          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <a
                  href="https://www.linkedin.com/company/rumodigital-pt"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-2 flex items-center gap-3 text-lg font-medium text-white transition hover:text-orange-400"
                >
                  ...
                  >
                    ...
                    <path
                      fill="#fff"
                      d="M6.94 8.5H4.56v10.02h2.38V8.5zM5.75 7.13a1.38 1.38 0 100-2.76 1.38 1.38 0 000 2.76zM19.44 18.52h-2.38v-5.4c0-1.29-.02-2.95-1.8-2.95-1.8 0-2.08 1.4-2.08 2.85v5.5H10.8V8.5h2.28v1.37h.03c.32-.6 1.1-1.23 2.27-1.23 2.43 0 2.88 1.6 2.88 3.68v6.2z"
                    />
                  </svg>
                  Rumo Digital
                </a>
